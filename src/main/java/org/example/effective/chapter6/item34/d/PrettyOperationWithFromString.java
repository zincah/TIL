 ...
 */
public enum PrettyOperationWithFromString {
    ...
    private static final Map<String, PrettyOperationWithFromString> map = Stream.of(values()).collect(toMap(Object::toString, e->e));

    public static Optional<PrettyOperationWithFromString> fromString(String symbol) {
